...
<div class="container" style="margin-top: 40px;">
    <h1 style="text-transform: uppercase; font-weight: 700;">[{{ count($product) }}] Kết quả tìm kiếm cho từ khóa "<span style="color: red;">{{ $key }}</span>"</h1>
</div>
<div class="shop-area" style="margin-top: 12px;">
    <div class="container">
        <div class="row">
                            ...
                            <div class="single-left-widget">
                                <div class="section-title">
                                    ...
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{ route('frontend.category', ['name_slug' => $value->name_slug]) }}" style="font-family: Roboto,-apple-system,BlinkMacSystemFont,Helvetica Neue,Helvetica,sans-serif!important;"><i class="fa fa-angle-right"></i>{{ $value->name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                            <div class="single-left-widget">
                                <div class="section-title">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('frontend.brand', ['name_slug' => $value->name_slug]) }}" style="font-family: Roboto,-apple-system,BlinkMacSystemFont,Helvetica Neue,Helvetica,sans-serif!important;">
