...
<head>
	...
	<title>Để Lại Lời Nhắn Thành Công</title>
...
<body>
	<main id="comingsoon" class="empty-state empty-state-fullpage bg-primary text-white" style="background-image: url(assets/images/illustration/img-1.png);">
		<div class="empty-state-container">
			<h1 class="state-header" style="letter-spacing: 4px;">ĐỂ LẠI LỜI NHẮN THÀNH CÔNG</h1>
			<p class="state-description lead">Cảm ơn bạn đã ghé thăm trang web của chúng tôi.</p>
			<a class="btn btn-warning" href="{{ route('frontend') }}"><i class="fas fa-home"></i> Về Trang Chủ</a>
