...
<body>
	<main id="comingsoon" class="empty-state empty-state-fullpage bg-primary text-white" style="background-image: url(assets/images/illustration/img-1.png);">
		<div class="empty-state-container">
			<h1 class="state-header" style="letter-spacing: 4px;">ĐẶT LẠI MẬT KHẨU THÀNH CÔNG</h1>
			<p class="state-description lead">Bây giờ bạn đã có thể đăng nhập.</p>
			<a class="btn btn-warning" href="{{ route('frontend.login') }}"><i class="fas fa-sign-in-alt"></i> Đăng Nhập</a>
