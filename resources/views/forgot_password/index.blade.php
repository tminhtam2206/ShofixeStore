...
<body>
	<main id="comingsoon" class="empty-state empty-state-fullpage bg-primary text-white" style="background-image: url(assets/images/illustration/img-1.png);">
		<div class="empty-state-container">
			<h1 class="state-header" style="letter-spacing: 4px;">QUYÊN MẬT KHẨU</h1>
			<p class="state-description lead">Vui lòng nhập thông tin bên dưới để tiến hành khôi phục mật khẩu của bạn.</p>
			<form class="w-75 mx-auto" method="post" action="{{ route('forgot.index.post') }}">
				@csrf
				<div class="form-group">
					<div class="input-group bg-white border-white input-group-lg circle">
						<input type="email" name="email" class="form-control text-black" placeholder="Địa chỉ email" autocomplete="off" required>
						<div class="input-group-append">
							<button type="submit" class="btn btn-warning circle">
                                <span class="d-none d-sm-inline">Khôi Phục</span>
